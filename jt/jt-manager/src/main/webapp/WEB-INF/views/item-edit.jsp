	    ...
	    <table cellpadding="5">
	        <tr>
	            ...
	            <td>
	            	...
	            	<input type="hidden" name="cid" id="selected" style="width: 280px;"/>
	            </td>
	        </tr>
	        <tr>
	            <td>商品标题:</td>
	        ...
	        <tr>
	            <td>商品图片:</td>
	            <td>
	            	<a href="javascript:void(0)" class="easyui-linkbutton picFileUpload" id="deleteImage">上传图片</a>
